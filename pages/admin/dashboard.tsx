        ...
        <div className="bg-gradient-to-br from-white to-slate-50 p-6 rounded-2xl shadow-lg border border-slate-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              ...
              className="group p-6 text-left bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-2xl hover:from-blue-100 hover:to-blue-200 transition-all duration-300 hover:scale-105 hover:shadow-lg"
            >
              <div className="flex items-center">
                <div className="p-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="ml-4">
                  <p className="font-bold text-slate-800 group-hover:text-blue-800">Gérer les Utilisateurs</p>
                  <p className="text-sm text-slate-600 mt-1">Voir et gérer tous les utilisateurs</p>
                </div>
              </div>
            </button>

            <button
              onClick={() => window.open('/admin/pdfs', '_self')}
              className="group p-6 text-left bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-2xl hover:from-green-100 hover:to-green-200 transition-all duration-300 hover:scale-105 hover:shadow-lg"
            >
              <div className="flex items-center">
                <div className="p-3 bg-gradient-to-r from-green-500 to-green-600 rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="ml-4">
                  <p className="font-bold text-slate-800 group-hover:text-green-800">Gérer les PDFs</p>
                  <p className="text-sm text-slate-600 mt-1">Voir et gérer tous les PDFs</p>
                </div>
              </div>
            </button>
            ...
            <button
              onClick={fetchStats}
              className="group p-6 text-left bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-2xl hover:from-purple-100 hover:to-purple-200 transition-all duration-300 hover:scale-105 hover:shadow-lg"
            >
              <div className="flex items-center">
                <div className="p-3 bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="ml-4">
                  <p className="font-bold text-slate-800 group-hover:text-purple-800">Actualiser</p>
                  <p className="text-sm text-slate-600 mt-1">Recharger les statistiques</p>
                </div>
              </div>
            </button>
          </div>
